<div align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:334155,50:6366F1,100:38BDF8&height=220&section=header&text=Omprakash&fontSize=68&fontColor=FFFFFF&fontAlignY=38&desc=Senior%20Data%20Engineer%20%7C%20AI%20Engineer%20%7C%20Cloud%20%26%20GenAI&descAlignY=58&descSize=19&animation=fadeIn" alt="Omprakash profile banner" />

  <h3>Data Engineering | Generative AI | Cloud Platforms</h3>

  <p>
    <img src="https://komarev.com/ghpvc/?username=omprakash-engineer&style=flat-square&color=4F46E5&label=PROFILE+VIEWS" alt="Profile views" />
    <a href="https://github.com/omprakash-engineer?tab=followers"><img src="https://img.shields.io/github/followers/omprakash-engineer?style=flat-square&color=2563EB&label=FOLLOWERS" alt="GitHub followers" /></a>
    <a href="https://github.com/omprakash-engineer?tab=repositories"><img src="https://img.shields.io/badge/REPOSITORIES-9-blue?style=flat-square" alt="Public repositories" /></a>
  </p>

  <p>
    <a href="mailto:vompreddy@gmail.com"><img src="https://img.shields.io/badge/EMAIL-vompreddy%40gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white" alt="Email Omprakash" /></a>
    <a href="https://github.com/omprakash-engineer"><img src="https://img.shields.io/badge/GITHUB-omprakash--engineer-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub profile" /></a>
  </p>
</div>
...
<div align="center">
  <img src="https://skillicons.dev/icons?i=python,azure,aws,docker,kubernetes,git,githubactions,fastapi,dotnet&theme=light" alt="Python, Azure, AWS, Docker, Kubernetes, Git, GitHub Actions, FastAPI, and .NET" />
</div>

<br />

```text
> engineering focus: reliable data platforms, lakehouse architecture, and production GenAI
> data systems: Azure | AWS | Databricks | Spark | Delta Lake | Airflow | Kafka | Snowflake
> applied AI: RAG | LLM applications | Azure OpenAI | Azure AI Search | MCP
> direction: secure, governed, observable, and scalable cloud engineering
```
...
I build dependable cloud data systems and practical AI solutions that turn complex data into useful products.

- **Data platforms:** high-throughput ETL/ELT, streaming, lakehouse architecture, and data quality.
- **Applied AI:** enterprise RAG, LLM integration, evaluation frameworks, and AI search.
- **Cloud engineering:** Azure and AWS architecture, containerized services, orchestration, and CI/CD.
